...
package org.tisonkun.nymph.rpc.network.buffer;
 ...
 *
 * <ul>
 *  <li>{@link FileSegmentManagedBuffer}: data backed by part of a file</li>
 *  <li>{@link NioManagedBuffer}: data backed by a NIO ByteBuffer</li>
 *  <li>{@link NettyManagedBuffer}: data backed by a Netty ByteBuf</li>
 * </ul>
 * <p>
...
public interface ManagedBuffer {
    /**
     * Number of bytes of the data. If this buffer will decrypt for all the views into the data,
