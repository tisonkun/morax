...
import org.tisonkun.nymph.rpc.network.io.LimitedInputStream;
...
public class FileSegmentManagedBuffer implements ManagedBuffer {
    ...
    public FileSegmentManagedBuffer(TransportConfig conf, File file, long offset, long length) {
        this.conf = conf;
        this.file = file;
        this.offset = offset;
        this.length = length;
    ...
    public String toString() {
        return "FileSegmentManagedBuffer{" + "file=" + file + ", offset=" + offset + ", length=" + length + '}';
    }
}
