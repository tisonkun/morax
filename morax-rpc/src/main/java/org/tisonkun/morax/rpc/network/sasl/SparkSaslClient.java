...
import static org.tisonkun.morax.rpc.network.sasl.SparkSaslServer.DEFAULT_REALM;
import static org.tisonkun.morax.rpc.network.sasl.SparkSaslServer.DIGEST;
import static org.tisonkun.morax.rpc.network.sasl.SparkSaslServer.QOP_AUTH;
import static org.tisonkun.morax.rpc.network.sasl.SparkSaslServer.QOP_AUTH_CONF;
import static org.tisonkun.morax.rpc.network.sasl.SparkSaslServer.encodeIdentifier;
import static org.tisonkun.morax.rpc.network.sasl.SparkSaslServer.encodePassword;
    ...
    public SparkSaslClient(String secretKeyId, SecretKeyHolder secretKeyHolder, boolean encrypt) {
        ...
        try {
            this.saslClient = Sasl.createSaslClient(
                    new String[] {DIGEST}, null, null, DEFAULT_REALM, saslProps, new ClientCallbackHandler());
