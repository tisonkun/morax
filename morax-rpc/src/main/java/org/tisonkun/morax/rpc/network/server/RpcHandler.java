...
import org.tisonkun.morax.rpc.network.client.StreamCallback;
...
public abstract class RpcHandler {
     ...
     * ({@link StreamCallback#onData(String, ByteBuffer)})
     * will fail the entire channel.  A failure in "post-processing" the stream in
     * {@link StreamCallback#onComplete(String)} will result in an
