...
package org.tisonkun.morax.rpc.network.protocol;

import io.netty.buffer.ByteBuf;
import java.util.Objects;
import org.tisonkun.morax.rpc.network.buffer.ManagedBuffer;
import org.tisonkun.morax.rpc.network.buffer.NettyManagedBuffer;

/**
 * Response to {@link ChunkFetchRequest} when a chunk exists and has been successfully fetched.
 * <p>
 * Note that the server-side encoding of these messages does NOT include the buffer itself, as this
...
public final class ChunkFetchSuccess extends AbstractResponseMessage {
    ...
    public String toString() {
        return "ChunkFetchSuccess{" + "streamChunkId=" + streamChunkId + '}';
    }
}
