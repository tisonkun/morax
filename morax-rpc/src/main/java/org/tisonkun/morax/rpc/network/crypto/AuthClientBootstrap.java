...
import org.tisonkun.morax.rpc.network.sasl.SaslClientBootstrap;
...
public class AuthClientBootstrap implements TransportClientBootstrap {
    ...
    public AuthClientBootstrap(TransportConfig conf, String appId, SecretKeyHolder secretKeyHolder) {
        this.conf = conf;
